...
declare_id!("6ErRa5iTigqP1kEZbZEGtfViLMMmubpoVgvkVNSrhWgE");
...
pub struct Initialize<'info> {
    ...
    #[account(init,seeds = [b"token-seed".as_ref()], bump = vault_account_bump, payer =
    initializer, token::mint = mint, token::authority = initializer,)]
